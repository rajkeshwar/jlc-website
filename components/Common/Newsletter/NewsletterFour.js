...
const NewsletterFour = (props) => {
  ...
  return (
    <div
      className={sectionClass ? sectionClass : "rs-newsletter style2"}
      style={bgStyle}
    >
            ...
            <div className="col-md-6">
              <div className="content-part md-mb-30">
                <SectionTitle
                  ...
                  titleClass={
                    titleClass ? titleClass : "title mb-10 white-color"
                  }
                  ...
                  bottomSubTitle={
                    bottomSubTitle ? bottomSubTitle : "Subscribe Newsletter "
                  }
                />
              </div>
            </div>
