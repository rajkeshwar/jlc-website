                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                <li><Link href="/course">eLearning School</Link></li>
                                <li><Link href="/about">About Us</Link></li>
                                <li><Link href="/course">Courses</Link></li>
                                <li><Link href="/contact">Become A Teacher</Link></li>
                        ...
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                ...
                                <li><Link href="/course-categories">Web Development</Link></li>
                                <li><Link href="/course-categories">Genarel Education</Link></li>
                                <li><Link href="/course-categories">Digital Marketing</Link></li>
                                <li><Link href="/course-categories">Web Design</Link></li>
                            </ul>
                        </div>
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                <li><Link href="/contact">Become A Teacher</Link></li>
                                <li><Link href="/team/team-single">Instructor/Student Profile</Link></li>
                                <li><Link href="/course">Courses</Link></li>
